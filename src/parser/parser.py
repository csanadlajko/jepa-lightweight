...
def parse_jepa_args():
    ...
    parser.add_argument("--result_folder", help="name of the result folder where checkpoints and results are created", default="results", type=str)
    parser.add_argument("--dataset", help="name of the training and testing dataset", default="cifar10", type=str)
    parser.add_argument("--dataset_input", help="name of input folder of a third party dataset", default="", type=str)
