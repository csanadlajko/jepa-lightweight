...
def parse_jepa_args():
    ...
    parser.add_argument("--finetune_lr", help="learning rate of the fine tuning algorithm (default 0.005)", default=0.005, type=float)
    parser.add_argument("--num_block_categories", help="number of classes when classifying target blocks (default: 90)", default=81, type=int)
